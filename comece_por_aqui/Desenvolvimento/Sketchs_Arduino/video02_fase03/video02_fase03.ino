...
const char* ssid = "Desktop_F8015306 2"; //Insira o SSID da rede
const char* password = "8489006830955485"; //Insira a senha da rede
...
// Link da publicacao: https://script.google.com/macros/s/AKfycbx3Yw3vKdp9GuNdxeeWvZVtPMBS-bmE38MbSUpzOIu7gULcfUAU/exec
